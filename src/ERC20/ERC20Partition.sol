...
abstract contract ERC20Partition is ERC20, IERC20Partition {
     ...
     * Emits a {Transfer} event.
     */
    function transferFrom(address from, address to, bytes32 id, uint256 amount, bytes memory data)
        public
        returns (bool)
    {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, bytes32 id, uint256 addedValue, bytes memory data)
        public
        virtual
        returns (bool)
    {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, bytes32 id, uint256 subtractedValue, bytes memory data)
        public
        virtual
        returns (bool)
    {
     ...
     */
    function _transfer(address from, address to, bytes32 id, uint256 amount, bytes memory data) internal virtual {
     ...
     * - `spender` cannot be the zero address.
     */
    function _approve(address owner, address spender, bytes32 id, uint256 amount, bytes memory data) internal virtual {
     ...
     */
    function _spendAllowance(address owner, address spender, bytes32 id, uint256 amount, bytes memory data)
        internal
        virtual
    {
        uint256 currentAllowance = allowance(owner, spender, id);
     ...
     */
    function _beforeTokenTransfer(address from, address to, bytes32 id, uint256 amount, bytes memory data)
        internal
        virtual
    {}
     ...
     * To learn more about hooks, head to xref:ROOT:extending-contracts.adoc#using-hooks[Using Hooks].
     */
    function _afterTokenTransfer(address from, address to, bytes32 id, uint256 amount, bytes memory data)
        internal
        virtual
    {}
}
